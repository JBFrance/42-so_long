...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/04/10 14:20:03 by jfrances          #+#    #+#             */
/*   Updated: 2023/04/10 14:20:14 by jfrances         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	grid_conditionals(t_parse *tl, int j, int i)
{
	...
	else if (tl->map[i][j] == 'B')
		mlx_put_image_to_window(tl->mlx, tl->win, \
			tl->spr.rem, j * 64, i * 64 + 35);
}
...
{
	tl->spr.player = mlx_xpm_file_to_image(tl->mlx, "sprites_xpm/player.xpm", &tl->spr.img_width, &tl->spr.img_height);
